data = {
    ...
    'Books': {
        'Sapiens: A Brief History of Humankind': ['History','Anthropology'],
        'The Elements of Style':['Writing ','Grammar'],
        'Atomic Habits':[ 'Self-Help','Psychology'],
        'Thinking, Fast and Slow': ['Psychology','Behavioral Economics'],
        'The Code Book':['Cryptography','History'],
        'A Brief History of Time' :[' Physics','Cosmology'],
        'Educated' :['Memoir','Education'],
        'The Innovators' :[ 'Technology','Innovation'],
        'The Art of War' :[ 'Philosophy','Military Strategy'],
    ...
    'Items': {
        'Portable Charger':['Electronics', 'Gadgets'],
        'Vases':['Home Decor'],
